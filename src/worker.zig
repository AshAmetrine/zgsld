...
const greeter_mod = @import("worker/greeter.zig");
const session_mod = @import("worker/session.zig");
const env_mod = @import("worker/env.zig");
...
const GreeterOpts = greeter_mod.GreeterOpts;
const Session = session_mod.Session;

pub const SessionWorkerOpts = struct {
    allocator: std.mem.Allocator,
};

pub const SessionWorker = struct {
    allocator: std.mem.Allocator,

    pub fn init(opts: SessionWorkerOpts) SessionWorker {
        return .{
            .allocator = opts.allocator,
        };
    }

    pub fn run(self: *SessionWorker) !void {
    ...
    fn runIpcLoop(self: *SessionWorker, opts: RunOpts) !void {
